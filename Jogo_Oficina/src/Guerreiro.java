...
class Guerreiro extends Personagem {
    ...
    public void atacar(Personagem inimigo) {
        ...
        while (rodando) {
            ...
            if (escolha == 1){
                if (this.stamina >= 10){
                    this.stamina -= 10;
                    System.out.print("O(a) guerreiro "+ this.nome + " usou sua espada, atacou e causou: " + dano + " de dano, no(a) "+ inimigo.nome +" e agora tem: " + this.stamina + " de stamina");
    ...
    void atacarAutomaticamente(Personagem inimigo) {
        ...
        if (this.stamina > 10 && this.stamina < 25){
            ...
            if (escolha == 0){
                ...
                int dano = random.nextInt(this.forca);
                inimigo.receberDano(dano);
                System.out.print("\nO(a) guerreiro "+ this.nome + " usou sua espada, atacou e causou: " + dano + " de dano, no(a) "+ inimigo.nome +" e agora tem: " + this.stamina + " de stamina");
            } else {
                recuperarStamina();
            }
        }
            ...
            if (escolha == 0){
                ...
                inimigo.receberDano(dano);
                System.out.println("\n" + this.nome + " jogou um escudo na cabeça do(a) " + inimigo.nome + " e o(a) acertou usando seu(sua) " + this.arma + ", causando: " + dano + " de dano em " + inimigo.nome + "!");
    ...
    public void recuperarStamina(){
        ...
        System.out.println("O(a) guerreiro " + this.nome + " se sentou para descansar e recuperou a sua stamina e agora tem: " + this.stamina);
    }
