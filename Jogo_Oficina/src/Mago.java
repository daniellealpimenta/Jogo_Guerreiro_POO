...
class Mago extends Personagem {
    ...
    public void atacar(Personagem inimigo) {
        ...
        while (rodando){
            ...
            System.out.println("""
                    ...
                    [1] - Atacar (15 de mana)
                    [2] - Recuperar Mana
                    [3] - Lançar Magia Forte (30 de mana)
            ...
            if (escolha == 1){
                if (this.mana >= 15){
                    this.mana -= 15;
                    System.out.println("O(a) mago(a) " + this.nome + " se concentrou e lançou uma magia no(a) " + inimigo.nome + " causando " + dano + " de dano, e agora tem: " + this.mana + " de mana");
    ...
    void atacarAutomaticamente(Personagem inimigo) {
        ...
        if (this.mana > 15 && this.mana < 30){
            ...
            if (escolha == 0){
                ...
                int dano = random.nextInt(this.forca);
                inimigo.receberDano(dano);
                System.out.println("\nO(a) mago(a) " + this.nome + " se concentrou e lançou uma magia no(a) " + inimigo.nome + " causando " + dano + " de dano, e agora tem: " + this.mana + " de mana");
            } else {
                recuperarMana();
            }
        }
    ...
    public void recuperarMana(){
        ...
        this.mana += recuperar;
        System.out.println("O(a) Mago(a) "+ this.nome + " começou a meditar e recuperou a sua mana e agora tem: " + this.mana);
    }
